            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'user.nickname', title: __('创建用户')},
                        ...
                        {field: 'buttons', title: __('Operate'), table: table, events: Table.api.events.operate, formatter: Table.api.formatter.buttons, buttons: [
                            {
                                    ...
                                    title: __('忽略'),
                                    classname: 'btn btn-xs btn-danger btn-ajax',
                                    url: 'bbs/report/thread/ignore/status/0',
                                    confirm: '确定忽略举报信息？',
                                    refresh:true,
                                ...
                                },
                            {
                                    ...
                                    url: 'bbs/report/thread/ignore/status/1',
                                    confirm: '确定取消忽略举报信息？',
                                    refresh:true,
